...
public class ContaBancaria {
	...
	public String buscar(String paramnome, String paramtipocliente, String paramcpfcnpj, 
			String paramOperacao, String paramdepvalor, String paramsacvalor, String paramdepsacvalor,
			String paramvalordeposito, String paramvalorsaque) {
		...
		//	saldo = saldo + valorDep;
			...
			if( valordeposito.equals(valordeposito) || valorsaque.equals(valorsaque)){
								//valord =Integer.parseInt(valordeposito);
								//valors = Integer.parseInt(valorsaque);
				if(valord >= 0) {
				saldo=+valord;
				this.setSaldo(saldo);
				retorno = Integer.toString(this.getSaldo());
