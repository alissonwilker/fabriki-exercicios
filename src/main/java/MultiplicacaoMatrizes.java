...
public class MultiplicacaoMatrizes {
	...
	/*	int matrizA[][] = new int[][] { { 2, 3 }, { 1, 0 }, { 4, 5 } }; //num de chaves=linhas e dentro das chaves = colunas
		int matrizB[][] = new int[][] { { 3, 1 }, { 2, 4 } };
		int matrizC[][] = new int [matrizA.length][matrizB[0].length]; // clunasXlinhas
