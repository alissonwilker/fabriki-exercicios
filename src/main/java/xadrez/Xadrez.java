...
import xadrez.movimentos.MovimentoRoque.RoqueDto;
...
public class Xadrez {
    ...
    public void retornarEstadoAnterior() {
        ...
        MovimentoRoque.RoqueDto roqueAnterior = estadoAnterior.getRoque(); // objeto
    ...
    public void moverPeca(String movimento) {
        ...
        if (pecaOrigem.getTipo() == Tipo.Peao && calcularDistanciaLinhas(idCasaOrigem, idCasaDestino) == 2) {
            ...
            // movimento de roque
            MovimentoRoque.RoqueDto roque = new MovimentoRoque().new RoqueDto(idCasaOrigem, idCasaDestino, this);
