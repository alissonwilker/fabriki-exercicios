...
public class MovimentoRoque extends Movimento {
    ...
    public boolean validar(String idCasaOrigem, String idCasaDestino, Xadrez xadrez) {
        ...
        boolean jogoEmXeque = corReiBranca ? situacaoJogo == Situacao.Xeque_Brancas
            : situacaoJogo == Situacao.Xeque_Pretas;

        if (jogoEmXeque || corReiBranca ? xadrez.isReiBrancoMovido() : xadrez.isReiPretoMovido()) {
            return false;
        }
    ...
    public boolean verificarObstrucaoDeslocamento(String idCasaOrigem, String idCasaDestino, Xadrez xadrez) {
        return super.verificarObstrucaoDeslocamento(idCasaOrigem, idCasaDestino, xadrez) || xadrez.get(idCasaDestino) != null;
    }
