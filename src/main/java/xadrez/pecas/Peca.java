...
import xadrez.movimentos.MovimentoPeao;
...
class Torre extends Peca {
    public Torre(Cor cor, String idCasa) {
        ...
        adicionar(Movimento.criarMovimentoHorizontalLivre());
        adicionar(Movimento.criarMovimentoVerticalLivre());
    }
...
class Rei extends Peca {
    public Rei(Cor cor, String idCasa) {
        ...
        adicionar(Movimento.criarMovimentoRestrito());
...
class Bispo extends Peca {
    public Bispo(Cor cor, String idCasa) {
        ...
        adicionar(Movimento.criarMovimentoDiagonalLivre());
    }
...
class Cavalo extends Peca {
    public Cavalo(Cor cor, String idCasa) {
        ...
        adicionar(Movimento.criarMovimentoL());
    }
...
class Peao extends Peca {
    public Peao(Cor cor, String idCasa) {
        ...
        adicionar(MovimentoPeao.criarMovimentoAvancaUma());
        adicionar(MovimentoPeao.criarMovimentoAvancaDuas());
        adicionar(MovimentoPeao.criarMovimentoCapturaDiagonal()); 
        adicionar(MovimentoPeao.criarMovimentoEnPassant());
    }
...
class PecaDeserializer extends StdDeserializer<Peca> {
