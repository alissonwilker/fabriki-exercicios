...
public class BancoServlet extends HttpServlet {
	...
	/**
	 * Recupera o nome do cliente (dono) da conta bancaria especificada em uma
	 * requisicao. A conta bancaria deve estar presente na sessao do usuario e esta
	 * deve ser recuperada atraves do metodo
	 * 'BancoServlet.recuperarContaBancaria(HttpServletRequest)'.
	 * 
	 * @param request
	 *            O objeto HttpServletRequest a partir do qual pode ser recuperada a
	 *            sessao do usuario e, consequentemente, as contas vinculadas a esse
	 *            usuario.
	 * @return O nome do cliente (dono) da conta bancaria presente na requisicao. Se
	 *         a conta nao estiver presente na sessao do usuario, o resultado eh uma
	 *         string vazia.
	 */
	...
	/**
	 * Recupera as contas vinculadas a sessao do usuario. Se nao houver contas
	 * vinculadas a sessao do usuario ainda, cria um mapa na sessao do usuario que
	 * mapeia os IDs das contas com as contas que serao vinculadas a esse usuario.
	 * 
	 * @param request
	 *            O objeto HttpServletRequest a partir do qual pode ser recuperada a
	 *            sessao do usuario e, consequentemente, as contas vinculadas a esse
	 *            usuario.
	 * @return Um mapa que mapeia os IDs das contas com as contas vinculadas ao
	 *         usuario.
	 */
	private Map<Integer, ContaBancaria> recuperarContasDaSessaoDoUsuario(HttpServletRequest request) {
		...
		session.setAttribute(ATRIB_CONTAS, contas);
		return contas;
	}
