...
public class BancoServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String retorno = contabancaria.buscar(paramnome, paramtipocliente, paramcpfcnpj,
		paramOperacao, paramdepvalor, paramsacvalor,
		paramdepsacvalor, paramvalordeposito, paramvalorsaque	);
