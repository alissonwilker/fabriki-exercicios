    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
        ...
        switch (paramOperacao) {
            ...
            case "depositarSacarValor":
                ...
                resposta = "Você depositou R$"+ valorDe +"e sacou R$"+ valorSa+ ", seu salgo agora é R$" +contaBancaria.getSaldo();
                break;
            case "recuperarSaldo":
                int saldo = contaBancaria.getSaldo();
                resposta = "Valor da conta é R$" + saldo;
                break;
        }
