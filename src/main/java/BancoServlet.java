...
public class BancoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Integer valorDeposito = Integer.parseInt(stringValorSaque);
		Integer valorSaque = Integer.parseInt(stringValorSaque);

		if(tipoCliente == "pessoaFisica"){
			PessoaFisica cliente = new PessoaFisica(nome, cpfCnpj);
			ContaBancaria cb = new ContaBancaria(cliente);
		} else if(tipoCliente == "pessoaJuridica"){
			PessoaJuridica cliente = new PessoaJuridica(nome, cpfCnpj);
			ContaBancaria cb = new ContaBancaria(cliente);
		}
