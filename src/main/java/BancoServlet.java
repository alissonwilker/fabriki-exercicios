...
public class BancoServlet extends HttpServlet {
    ...
    private String depositarSacarValor(HttpServletRequest request) {
        ...
        Integer saldo = new BancoBusiness().depositarSacarValor(contaBancaria,
    ...
    /**
     * Recupera o nome do cliente (dono) da conta bancaria especificada em uma requisicao.
     *  A conta bancaria deve estar presente na sessao do usuario e esta deve ser
     *  recuperada atraves do metodo
     * 'BancoServlet.recuperarContaBancaria(HttpServletRequest)'.
     * 
     * @param request
     *            O objeto HttpServletRequest a partir do qual pode ser recuperada
     *             a sessao do usuario
     *            e, consequentemente, as contas vinculadas a esse usuario.
     * @return O nome do cliente (dono) da conta bancaria presente na requisicao.
     *  Se a conta nao estiver
    ...
    private String criarContaBancaria(HttpServletRequest request) {
        BancoBusiness.TipoCliente tipoCliente = Enum.valueOf(BancoBusiness.TipoCliente.class,
        		tipoClienteStr);
