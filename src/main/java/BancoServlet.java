...
public class BancoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		case recuperarNomeCliente:
			resposta = ((Cliente) contaBancaria.getCliente()).getNome();
			break;
		case recuperarCpfCliente:
			if (TipoCliente.pessoaFisica.equals(tipoCliente)) {
				resposta = ((PessoaFisica) contaBancaria.getCliente());
			}
			break;
		case recuperarCnpjCliente:
			if (TipoCliente.pessoaJuridica.equals(tipoCliente)) {
				resposta = ((PessoaJuridica) contaBancaria.getCliente());
			}
			break;
		case recuperarSaldo:
	...
	private ContaBancaria criarContaBancaria(String nomeCliente, String cpfCnpj, Object tipoCliente) {
