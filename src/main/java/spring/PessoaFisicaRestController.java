...
public class PessoaFisicaRestController {
	...
	public PessoaFisica updatePessoaFisica(@PathVariable String id, PessoaFisica pessoaFisica) {
    	return persistirPessoaFisica(pessoaFisica);
	}
     ...
     * @return a pessoa fisica alterada.
     */
	public PessoaFisica persistirPessoaFisica(PessoaFisica pessoaFisica) {
