...
public class PessoaFisicaRestController {
    ...
    /**
     * Recupera uma pessoa fisica pelo cpf.
     * 
     * @param id o cpf da pessoa fisica a ser recuperada.
     ...
     * 
     * @param id            o cpf da pessoa fisica a ser alterada.
    ...
    public @ResponseBody PessoaFisica updatePessoaFisica(@PathVariable String cpf,
    ...
    /**
     * Remove uma pessoa fisica identificada pelo cpf.
     * 
